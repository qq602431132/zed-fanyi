...
impl ModalView for FeedbackModal {
    fn on_before_dismiss(&mut self, cx: &mut ViewContext<Self>) -> DismissDecision {
        ...
        let answer = cx.prompt(PromptLevel::Info, "丢弃反馈?", None, &["Yes", "No"]);
...
impl FeedbackModal {
    ...
    pub fn new(
        ...
        let email_address_editor = cx.new_view(|cx| {
            ...
            editor.set_placeholder_text("电子邮箱地址(可选)", cx);
        ...
        let feedback_editor = cx.new_view(|cx| {
            ...
            editor.set_placeholder_text(
                "你可以使用 markdown(标记语言)来通过代码和链接整理你的反馈内容.",
                cx,
            );
        ...
        v_flex()
            ...
            .child(
                v_flex()
                    ...
                    .child(
                        Label::new("如果您希望我们能够回复,请提供一个电子邮箱地址.")
