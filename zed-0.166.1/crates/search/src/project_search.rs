...
impl ProjectSearchView {
    ...
    pub fn new(
        ...
        let query_editor = cx.new_view(|cx| {
            ...
            editor.set_placeholder_text("查找所有文件…", cx);
        ...
        let replacement_editor = cx.new_view(|cx| {
            let mut editor = Editor::single_line(cx);
            editor.set_placeholder_text("在项目中替换…", cx);
        ...
        let included_files_editor = cx.new_view(|cx| {
            let mut editor = Editor::single_line(cx);
            editor.set_placeholder_text("包括: crates/**/*.toml", cx);
        ...
        let excluded_files_editor = cx.new_view(|cx| {
            let mut editor = Editor::single_line(cx);
            editor.set_placeholder_text("不包括: vendor/*, *.lock", cx);
    ...
    fn landing_text_minor(&self, cx: &mut ViewContext<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(
                Button::new("match-whole-words", "整个单词")
        ...
        let mode_column = h_flex()
            ...
            .child(
                IconButton::new("project-search-filter-button", IconName::Filter)
                    ...
                    .tooltip(|cx| Tooltip::for_action("包含/排除特定路径", &ToggleFilters, cx))
                    ...
                    h_flex()
                        ...
                        .child(
                            IconButton::new("project-search-opened-only", IconName::FileSearch)
                                ...
                                .tooltip(|cx| Tooltip::text("仅查找打开的文件", cx))
                                .on_click(cx.listener(|this, _, cx| {
